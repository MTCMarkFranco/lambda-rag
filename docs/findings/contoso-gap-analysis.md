...
**End-to-end verification on the Contoso test contract is deferred to
[P1.8 #17](https://github.com/MTCMarkFranco/lambda-rag/issues/17)** —
the Contoso contract is not yet in the golden corpus, so the
...
will regress on real Contoso inputs once they land in
