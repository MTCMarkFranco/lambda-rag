...
///
/// Visual parity with the Air Canada agent-based reviewer (🕵 prefix,
...
{
    /// <summary>
    /// Detective emoji + " - " — matches Air Canada's tracked-changes
    ...
    /// Air Canada reviewer: <c>"🕵 - {Label} guidance"</c>.
    /// </summary>
    ...
    /// Matches Air Canada's _severity_banner emoji set so reviewers see
