...
/// non-Air-Canada</em> ruleset and a synthetic projected document, then
/// evaluating end-to-end. If a future change accidentally hardcodes
/// behaviour against AC rule ids, contract topics, or specific keyword
...
public class GenericTextFeaturesEvaluationTests
{
    ...
    {
        // Synthetic vendor policy unrelated to AC: minimum project bond
        // must be >= $2,500,000.
        var rule = Rule(
            "VENDOR-BOND-MIN",
